...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("RISE");
    case mBTC: return QString("mRISE");
    case uBTC: return QString::fromUtf8("μRISE");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("RISE");
    case mBTC: return QString("Milli-RISE (1 / 1,000)");
    case uBTC: return QString("Micro-RISE (1 / 1,000,000)");
    default: return QString("???");
    }
}
