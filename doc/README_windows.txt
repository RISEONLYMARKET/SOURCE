RISE 0.1.2
Copyright (c) 2014 RISE developers
...
About RISE
---------------
RISE is a RISE network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the RISE reference
wallet (http://github.com/RISE/RISE). 

To help faciliate broad community cooperation, a number of trusted 
RISE/Peershares community leaders have write permissions to the project's 
...
Resources
---------
RISE source code: https://github.com/RISE/RISE

For the most current instructions covering how to compile RISE from 
source on a variety of operating systems, please visit:
https://github.com/RISE/RISE/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/RISE/RISE/issues?state=open

RISE discussion forums (hosted by RISETalk.org): 
http://www.RISEtalk.org/index.php?board=64.0



Acknowledgements
----------------
RISE owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:


	RISE (RISE) 0.4.0 BETA
	Copyright (c) 2011-2014 Bitcoin Developers

	Distributed under the MIT/X11 software license
	(http://www.opensource.org/licenses/mit-license.php)

	RISE is a free open source project with the goal of providing a 
