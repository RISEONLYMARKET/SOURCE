        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start RISE on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start RISE after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the RISE client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show RISE addresses in the transaction list"));
