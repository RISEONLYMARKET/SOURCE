...
{
    resize(850, 550);
    setWindowTitle(tr("RISE Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/RISE_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a RISE address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/RISE_tooltip"), tr("&About RISE"), this);
    aboutAction->setToolTip(tr("Show information about RISE"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for RISE"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/RISE_tooltip"), tr("Show/Hide &RISE"), this);
    toggleHideAction->setToolTip(tr("Show or hide the RISE window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/RISE_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/RISE_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/RISE_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("RISE client"));
    trayIcon->setIcon(QIcon(":/icons/RISE_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RISE network", "", count));
}
