...
// Copyright (c) 2012-2013 The RISE developers
...
// RISE version - intended for display purpose only
#define RISE_VERSION_MAJOR       1
#define RISE_VERSION_MINOR       0
#define RISE_VERSION_REVISION    0
#define RISE_VERSION_BUILD       0

static const int RISE_VERSION =
                           1000000 * RISE_VERSION_MAJOR
                         +   10000 * RISE_VERSION_MINOR
                         +     100 * RISE_VERSION_REVISION
                         +       1 * RISE_VERSION_BUILD;

// RISE version - reference for code tracking
