...
// RISE message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0x1a, 0x1b, 0x1c, 0x1d };
static unsigned char pchMessageStartRISE[4] = { 0xb1, 0xc3, 0xd2, 0xa4 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartRISE : pchMessageStartBitcoin, sizeof(pchMessageStartRISE));
}
